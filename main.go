...
import (
	...
	"github.com/phpc0de/ctpango/cmder/cmdliner/args"
	"github.com/phpc0de/ctpango/cmder/cmdutil"
	"github.com/phpc0de/ctpango/cmder/cmdutil/escaper"
	"github.com/phpc0de/ctpango/internal/command"
	"github.com/phpc0de/ctpango/internal/config"
	"github.com/phpc0de/ctpango/internal/panupdate"
...
func main() {
	...
	app.Version = Version
	app.Author = "tickstep/cloudpan189-go: https://github.com/phpc0de/ctpango"
	...
	------------------------------------------------------------------------------
	前往 https://github.com/phpc0de/ctpango 以获取更多帮助信息!
	前往 https://github.com/phpc0de/ctpango/releases 以获取程序更新信息!
	------------------------------------------------------------------------------

	交流反馈:
		提交Issue: https://github.com/phpc0de/ctpango/issues
